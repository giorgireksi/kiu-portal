...
PUBLIC_APP_URL="${KIU_PUBLIC_APP_URL:-http://${PUBLIC_HOST}:${FRONTEND_PORT}}"
PUBLIC_BACKEND_URL="${KIU_PUBLIC_BACKEND_URL:-http://${PUBLIC_HOST}:${BACKEND_PORT}}"
FRONTEND_URL="${PUBLIC_APP_URL}/lms.html"
LOGIN_URL="${PUBLIC_APP_URL}/login.html"
SETUP_URL="${PUBLIC_APP_URL}/wifi-setup.html"
...
export KIU_PUBLIC_APP_URL="$PUBLIC_APP_URL"
