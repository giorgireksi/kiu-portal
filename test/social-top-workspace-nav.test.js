...
describe('social shortcuts top nav + desktop rail', () => {
    it('restores desktop workspace rail and mounts bottom-nav-style Social Shortcuts on phone', () => {
        ...
        expect(html).toMatch(/social-page-interactions-runtime\.js\?v=20260807-shortcutscue2/);
        expect(sw).toContain("CACHE_NAME = 'kiu-portal-shell-v20260808-mobileroute1'");
    });
