...
describe('social post actions regressions', () => {
    it('keeps feed mutations, dialogs, and comment drafts in the render pipeline', () => {
        ...
        expect((source + feedModule)).toContain('lux-strip-card surface-card');
        ...
        expect(commentsRuntime).toContain('sns-comment-dialog-bubble');
        ...
        expect(feedModule).toContain('lux-glass-dialog-backdrop--stacked-child lux-glass-dialog-backdrop--comment-delete');
        expect(readSource('assets/css/lux-modals.css')).toContain('.social-comments-dialog-stack');
