...
describe('Social Messages loading animation', () => {
    ...
    it('loads Messages motion before Social interactions', () => {
        ...
        const messagesIndex = html.indexOf('social-messages-loading-runtime.js?v=20260818-centerobserver1&perf=20260816-singleowner4');
    ...
    it('cache-busts Messages assets', () => {
        ...
        expect(sw).toContain('social-messages-loading-runtime.js?v=20260818-centerobserver1&perf=20260816-singleowner4');
