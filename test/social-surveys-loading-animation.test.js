...
describe('Social Surveys loading animation', () => {
    ...
    it('loads Surveys motion before Social interactions', () => {
        ...
        const surveysIndex = html.indexOf('social-surveys-loading-runtime.js?v=20260818-centerobserver1&perf=20260816-singleowner3');
    ...
    it('cache-busts Surveys assets', () => {
        ...
        expect(sw).toContain('social-surveys-loading-runtime.js?v=20260818-centerobserver1&perf=20260816-singleowner3');
