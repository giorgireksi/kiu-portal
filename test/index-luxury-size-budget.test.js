...
describe('Phase A CSS stack (shell + fouc-ht)', () => {
    ...
    it('only index.html links lux-fouc-ht; portals link merged shell/controls', () => {
        for (const page of readdirSync(process.cwd()).filter((f) => f.endsWith('.html'))) {
            ...
            } else if (html.includes('lux-page-bare') || (html.includes('lux-shell.css') && !html.includes('index-home-layout'))) {
