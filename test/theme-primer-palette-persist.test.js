...
describe('theme primer palette/static persist', () => {
    it('shares visual defaults version with index-luxury and always reads stored palette/static fill', () => {
        ...
        expect(primer).toContain("LUXURY_VISUAL_DEFAULTS_VERSION = '20260723-adaptive-render-defaults1'");
        expect(luxury).toContain("FORCED_LUXURY_VISUAL_DEFAULTS_VERSION = '20260723-adaptive-render-defaults1'");
