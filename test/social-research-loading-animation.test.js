...
describe('Social Research loading animation', () => {
    ...
    it('loads Research motion before Social interactions', () => {
        ...
        const researchIndex = html.indexOf('social-research-loading-runtime.js?v=20260818-centerobserver1&perf=20260816-singleowner3');
    ...
    it('cache-busts Research assets', () => {
        ...
        expect(sw).toContain('social-research-loading-runtime.js?v=20260818-centerobserver1&perf=20260816-singleowner3');
