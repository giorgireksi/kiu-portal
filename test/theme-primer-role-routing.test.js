...
describe('theme primer role routing', () => {
  ...
  it('loads the primer synchronously before body content on unified entry routes', () => {
    for (const route of ['index.html', 'social.html', 'exam-portal.html']) {
      ...
      expect(html.indexOf('theme-primer.js?v=20260817-themeinstant5')).toBeGreaterThanOrEqual(0);
      expect(html.indexOf('theme-primer.js?v=20260817-themeinstant5')).toBeLessThan(html.indexOf('<body'));
    }
