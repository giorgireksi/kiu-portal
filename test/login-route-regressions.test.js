...
describe('login route regressions', () => {
    it('keeps login on delegated auth controls without dashboard shell baggage', () => {
        ...
        expect(html).toContain('assets/js/pages/login-runtime.js?v=20260823-groupactivity4');
        ...
        expect(runtimeSource).toContain("navigator.serviceWorker.register('/service-worker.js?v=20260823-groupactivity4'");
