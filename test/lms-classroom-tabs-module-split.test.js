...
describe('LMS classroom tabs module split', () => {
    it('moves LMS classroom tabs and tab coordinator ownership out of lms.js and into the dedicated runtime module', () => {
        ...
        expect(classroomSource).toContain('class="lms-route-card lms-route-panel-compact lms-session-official-card lms-next-session-card home-hover-chip');
        expect(classroomSource).toContain('class="lms-route-panel lms-route-panel-compact lms-session-marker-composer home-hover-chip"');
        expect(classroomSource).toContain('class="lms-route-card lms-route-panel-compact lms-session-marker-card home-hover-chip is-');
