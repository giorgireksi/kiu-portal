...
describe('LMS materials module split', () => {
    it('moves LMS materials rendering and mutation helpers out of lms.js and into the dedicated module', () => {
        ...
        expect(materialsSource).toContain('class="lux-secondary-btn lms-route-btn-compact"');
        ...
        expect(materialsSource).toContain('class="lux-secondary-btn lms-route-btn-compact lms-route-btn-compact-square"');
        expect(materialsSource).toContain('class="lux-secondary-btn lms-route-btn-compact lms-route-btn-compact-square lms-route-btn-danger"');
        expect(materialsSource).not.toContain('kiu-btn');
