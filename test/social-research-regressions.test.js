...
describe('social-research-regressions', () => {
    ...
    it('catalog keeps Faculty / Student / Mine tabs and fileKind filters', () => {
        ...
        expect(research).toContain('No pinned research yet');
        expect(research).toMatch(/social-neo-research-grid">\$\{researchPinModel\(\)\.renderPinnedSections/);
        ...
        expect(html).toContain('social-page.js?v=20260802-dialogscroll1');
    ...
    it('bare-lite + primitives cover research deposit shell', () => {
        ...
        const research = readSource('assets/js/pages/social-research.js');
        expect(research).toContain('social-neo-entity-card social-neo-research-card');
        ...
        expect(bare).toContain('.social-neo-research-card-open');
        ...
        expect(primitives).toContain('.social-neo-research-card-file.lux-panel-copy');
        ...
        expect(fouc).toContain('.social-neo-research-card');
        expect(fouc).toContain('.social-pin-section');
        expect(fouc).toContain('.social-neo-survey-listings');
