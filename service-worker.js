...
const SHELL_ASSETS = [
  ...
  '/assets/css/lux-shell.css?v=20260818-navmotionfix1',
  ...
  '/assets/js/theme-primer.js?v=20260818-shellcontent1',
  '/assets/js/app/social-standalone-bootstrap.js?v=20260818-shellfailopen1',
  '/assets/js/features/navigation.js?v=20260818-shellfailopen1',
  '/assets/js/shared/news-home.js?v=20260809-homeassembly2',
  '/assets/js/shared/lux-assembly-loading-runtime.js?v=20260818-contentpaint1',
  ...
  '/assets/js/features/luxury-shell-motion-runtime.js?v=20260818-navmotionfix1',
