...
const SHELL_ASSETS = [
  ...
  '/assets/js/theme-primer.js?v=20260817-instantassembly1',
  '/assets/js/app/social-standalone-bootstrap.js?v=20260816-socialrecovery2',
  '/assets/js/features/navigation.js?v=20260817-instantassembly1',
  '/assets/js/shared/news-home.js?v=20260809-homeassembly2',
  '/assets/js/shared/lux-assembly-loading-runtime.js?v=20260817-instantassembly1',
