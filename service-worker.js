...
const SHELL_ASSETS = [
  ...
  '/assets/css/lux-shell.css?v=20260818-routecover1',
  ...
  '/assets/js/theme-primer.js?v=20260818-shellvisible1',
  ...
  '/assets/js/features/index-luxury.js?v=20260818-shellpriority1',
