...
const routeVisualClassification = {
    'admin-library.html': { category: 'standard-shell', dedicatedCss: ['assets/css/route-bare/library/lux-page-bare-lite.css'], mobileShell: 'shared-standalone' },
    ...
    'chancellery.html': { category: 'standard-shell', dedicatedCss: ['assets/css/route-bare/chancellery/lux-page-bare-lite.css'], mobileShell: 'shared-standalone' },
    'exam-portal.html': { category: 'excluded-route', dedicatedCss: ['assets/css/route-bare/lms/lux-page-bare-lite.css'], mobileShell: 'none' },
    'exams.html': { category: 'special-surface', dedicatedCss: ['assets/css/route-bare/exams/lux-page-bare-lite.css'], mobileShell: 'shared-standalone' },
    ...
    'news.html': { category: 'standard-shell', dedicatedCss: ['assets/css/route-bare/news/lux-page-bare-lite.css'], mobileShell: 'shared-standalone' },
    'orders.html': { category: 'standard-shell', dedicatedCss: ['assets/css/route-bare/orders/lux-page-bare-lite.css'], mobileShell: 'shared-standalone' },
    'personal-data.html': { category: 'standard-shell', dedicatedCss: ['assets/css/route-bare/personal/lux-page-bare-lite.css'], mobileShell: 'shared-standalone' },
    'profile.html': { category: 'excluded-route', dedicatedCss: ['assets/css/redirect-route.css'], mobileShell: 'none' },
    'profile-view.html': { category: 'standard-shell', dedicatedCss: ['assets/css/route-bare/core/lux-page-bare-lite.css'], mobileShell: 'shared-standalone' },
    'programs.html': { category: 'standard-shell', dedicatedCss: ['assets/css/route-bare/programs/lux-page-bare-lite.css'], mobileShell: 'shared-standalone' },
    'protected-launch.html': { category: 'excluded-route', dedicatedCss: ['assets/css/protected-launch-route.css'], mobileShell: 'none' },
    'registration.html': { category: 'standard-shell', dedicatedCss: ['assets/css/route-bare/registration/lux-page-bare-lite.css'], mobileShell: 'shared-standalone' },
    ...
    'timetable.html': {
        category: 'standard-shell',
        dedicatedCss: ['assets/css/layout-schedule-board.css', 'assets/css/route-bare/timetable/lux-page-bare-lite.css'],
        mobileShell: 'shared-standalone'
    },
