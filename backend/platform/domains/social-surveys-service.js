...
function createSocialSurvey(payload = {}, actorId = '') {
    ...
    const survey = {
        ...
        visibility,
        audience,
        facultyCode: normalizeCode(this.getSocialActorFacultyCode(creatorId)),
        audienceFacultyCode: normalizeCode(payload.audienceFacultyCode || this.getSocialActorFacultyCode(creatorId)),
        scopeType,
        scopeId,
        scopeName,
