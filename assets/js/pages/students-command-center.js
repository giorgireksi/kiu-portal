...
// --- READABILITY: Render ---
        ...
        return `
            ...
            <section class="students-hub-info-card is-full lux-data-card home-hover-chip">
                ...
                <div class="students-hub-inline-actions students-hub-inline-actions--spaced lux-btn-row-stack">
                    ...
                    <button class="lux-secondary-btn" type="button" data-student-action="login-credentials" data-staff-id="${escapeHtml(record.id)}" ${canManage ? '' : 'disabled'}><i class="fas fa-key"></i> Generate login credentials</button>
    ...
    function handleAction(action, element) {
        ...
        if (action === 'login-credentials') {
            const record = buildStudentRecords(typeof getCurrentFaculty === 'function' ? getCurrentFaculty() : 'ECON').records
            ...
            window.provisionAdminAccountCredentials({
                id: staffId,
                ...(record || {}),
                role: record?.platformRole || 'student'
