(function initSocialWorkspaceModule() {
    ...
    window.sortProjectBoardTasksByPriority = sortProjectBoardTasksByPriority;
    window.filterProjectBoardTasks = filterProjectBoardTasks;
    window.resolveDeskTaskReadiness = resolveDeskTaskReadiness;
    window.resolveProjectTaskPriorityDisplay = resolveProjectTaskPriorityDisplay;
    window.buildProjectTaskInspectorFields = buildProjectTaskInspectorFields;
    window.syncProjectTaskMatrixPreview = syncProjectTaskMatrixPreview;
    window.projectTabPaneCacheKey = projectTabPaneCacheKey;
    window.syncProjectTabPills = syncProjectTabPills;
    window.clearProjectTabPaneCacheKey = clearProjectTabPaneCacheKey;
    window.clearProjectTabPaneCache = clearProjectTabPaneCache;
    window.deskTasksSurfaceReady = deskTasksSurfaceReady;
    window.syncDeskToolbarFromFreshMarkup = syncDeskToolbarFromFreshMarkup;
    window.getOrCreateProjectTabPane = getOrCreateProjectTabPane;
    window.refreshProjectTasksTabBody = refreshProjectTasksTabBody;
    window.refreshProjectTasksTabPane = refreshProjectTasksTabPane;
    window.rebuildActiveProjectTabPaneIfPreviewHost = rebuildActiveProjectTabPaneIfPreviewHost;
    window.patchProjectWorkspaceTab = patchProjectWorkspaceTab;
    window.revealDeskExpandTarget = revealDeskExpandTarget;
