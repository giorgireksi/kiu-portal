(function initStudentServiceFiltersModule() {
    ...
    __kiuSsApi.getStudentServiceDefaultSearchFilter = getStudentServiceDefaultSearchFilter;
    __kiuSsApi.buildStudentServiceMinimalInboxFilterLayout = buildStudentServiceMinimalInboxFilterLayout;
    __kiuSsApi.isStudentServiceCustomInboxFilter = isStudentServiceCustomInboxFilter;
    __kiuSsApi.buildStudentServiceDefaultInboxFilterLayout = buildStudentServiceDefaultInboxFilterLayout;
    __kiuSsApi.normalizeStudentServiceInboxFilterOption = normalizeStudentServiceInboxFilterOption;
    __kiuSsApi.deriveStudentServiceInboxFilterOptionValue = deriveStudentServiceInboxFilterOptionValue;
    __kiuSsApi.getStudentServiceEditableCustomFilterOptions = getStudentServiceEditableCustomFilterOptions;
    __kiuSsApi.getStudentServiceCustomInboxFilterDefaultValue = getStudentServiceCustomInboxFilterDefaultValue;
    __kiuSsApi.normalizeCustomInboxFilterOptions = normalizeCustomInboxFilterOptions;
    __kiuSsApi.normalizeStudentServiceInboxFilterEditorDraftFilters = normalizeStudentServiceInboxFilterEditorDraftFilters;
    __kiuSsApi.normalizeStudentServiceInboxFilterEntry = normalizeStudentServiceInboxFilterEntry;
    __kiuSsApi.normalizeStudentServiceInboxFilterLayout = normalizeStudentServiceInboxFilterLayout;
    __kiuSsApi.ensureStudentServiceInboxFilterLayoutHasSearch = ensureStudentServiceInboxFilterLayoutHasSearch;
    __kiuSsApi.finalizeStudentServiceInboxFilterLayout = finalizeStudentServiceInboxFilterLayout;
    __kiuSsApi.studentServiceInboxFilterLayoutHasDropdowns = studentServiceInboxFilterLayoutHasDropdowns;
    __kiuSsApi.studentServiceInboxFilterLayoutFingerprint = studentServiceInboxFilterLayoutFingerprint;
    __kiuSsApi.persistStudentServiceSharedInboxFilterLayout = persistStudentServiceSharedInboxFilterLayout;
    __kiuSsApi.maybeSyncStudentServicePersonalInboxFilterLayoutToTeam = maybeSyncStudentServicePersonalInboxFilterLayoutToTeam;
    __kiuSsApi.readStudentServiceInboxFilterPrefs = readStudentServiceInboxFilterPrefs;
    __kiuSsApi.readStudentServicePersonalInboxFilterLayout = readStudentServicePersonalInboxFilterLayout;
    __kiuSsApi.writeStudentServicePersonalInboxFilterLayout = writeStudentServicePersonalInboxFilterLayout;
    __kiuSsApi.clearStudentServicePersonalInboxFilterLayout = clearStudentServicePersonalInboxFilterLayout;
    __kiuSsApi.getStudentServiceSharedInboxFilterLayout = getStudentServiceSharedInboxFilterLayout;
    __kiuSsApi.getStudentServicePublicInboxFilterLayout = getStudentServicePublicInboxFilterLayout;
    __kiuSsApi.publishStudentServiceInboxFilterLayout = publishStudentServiceInboxFilterLayout;
    __kiuSsApi.pruneStudentServiceCustomTicketFilters = pruneStudentServiceCustomTicketFilters;
    __kiuSsApi.getStudentServicePublishedInboxFilterLayout = getStudentServicePublishedInboxFilterLayout;
    __kiuSsApi.publishStudentServiceInboxFilterLayoutFromEffective = publishStudentServiceInboxFilterLayoutFromEffective;
    __kiuSsApi.getStudentServiceEffectiveInboxFilterLayout = getStudentServiceEffectiveInboxFilterLayout;
    __kiuSsApi.resolveStudentServiceInboxFilterLayout = resolveStudentServiceInboxFilterLayout;
    __kiuSsApi.getStudentServiceInboxFilterValue = getStudentServiceInboxFilterValue;
    __kiuSsApi.setStudentServiceInboxFilterValue = setStudentServiceInboxFilterValue;
    __kiuSsApi.getStudentServiceInboxFilterOptions = getStudentServiceInboxFilterOptions;
    __kiuSsApi.ticketMatchesStudentServiceInboxFilter = ticketMatchesStudentServiceInboxFilter;
    __kiuSsApi.renderStudentServiceInboxFilterControlMarkup = renderStudentServiceInboxFilterControlMarkup;
    __kiuSsApi.renderStudentServiceInboxDropdownFiltersMarkup = renderStudentServiceInboxDropdownFiltersMarkup;
    __kiuSsApi.renderStudentServiceInboxFiltersMarkup = renderStudentServiceInboxFiltersMarkup;
    __kiuSsApi.buildStudentServiceTicketIntakeFromInboxFilters = buildStudentServiceTicketIntakeFromInboxFilters;
    __kiuSsApi.cloneStudentServiceInboxFilterLayout = cloneStudentServiceInboxFilterLayout;
    __kiuSsApi.buildStudentServiceInboxFilterEditorDraft = buildStudentServiceInboxFilterEditorDraft;
    __kiuSsApi.renderStudentServiceInboxFilterEditorRowMarkup = renderStudentServiceInboxFilterEditorRowMarkup;
    __kiuSsApi.renderStudentServiceInboxFilterEditorModalShell = renderStudentServiceInboxFilterEditorModalShell;
    __kiuSsApi.syncStudentServiceInboxFilterEditorPickers = syncStudentServiceInboxFilterEditorPickers;
    __kiuSsApi.isStudentServiceInboxFilterEditorOpen = isStudentServiceInboxFilterEditorOpen;
    __kiuSsApi.mountStudentServiceInboxFilterEditorModal = mountStudentServiceInboxFilterEditorModal;
    __kiuSsApi.openStudentServiceInboxFilterEditorModal = openStudentServiceInboxFilterEditorModal;
    __kiuSsApi.closeStudentServiceInboxFilterEditorModal = closeStudentServiceInboxFilterEditorModal;
    __kiuSsApi.remountStudentServiceInboxFilterEditorModal = remountStudentServiceInboxFilterEditorModal;
    __kiuSsApi.syncStudentServiceInboxFilterEditorDraftFromDom = syncStudentServiceInboxFilterEditorDraftFromDom;
    __kiuSsApi.moveStudentServiceInboxFilterEditorRow = moveStudentServiceInboxFilterEditorRow;
    __kiuSsApi.addStudentServiceInboxFilterEditorCustomFilter = addStudentServiceInboxFilterEditorCustomFilter;
    __kiuSsApi.addStudentServiceInboxFilterEditorOption = addStudentServiceInboxFilterEditorOption;
    __kiuSsApi.removeStudentServiceInboxFilterEditorOption = removeStudentServiceInboxFilterEditorOption;
    __kiuSsApi.removeStudentServiceInboxFilterEditorFilter = removeStudentServiceInboxFilterEditorFilter;
    __kiuSsApi.saveStudentServicePersonalInboxFilterLayoutFromEditor = saveStudentServicePersonalInboxFilterLayoutFromEditor;
    __kiuSsApi.saveStudentServiceSharedInboxFilterLayoutFromEditor = saveStudentServiceSharedInboxFilterLayoutFromEditor;
