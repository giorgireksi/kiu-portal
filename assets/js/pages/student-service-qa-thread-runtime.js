        ...
        <section class="student-service-zone student-service-zone-find">
            ...
            <div class="lux-panel-head">
                ...
                <div>
                    ...
                    <div class="student-service-kicker lux-section-kicker">Campus feed</div>

                    <div class="lux-panel-title lux-page-title">Search first, then open the thread that fits your question.</div>

                    <div class="lux-panel-copy lux-page-copy">Questions stay in one central feed, and each thread expands inline instead of opening a separate detail pane.</div>
