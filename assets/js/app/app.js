...
(function enablePortalPerformanceProbeFromQuery() {
    try {
        ...
        import('../shared/lux-render-governor.js?v=20260820-shellinput1')
...
(function ensurePortalApiRuntimeAvailability() {
    ...
    const LMS_CLASSROOM_TABS_RUNTIME_SCRIPT = 'assets/js/pages/lms-classroom-tabs-runtime.js?v=20260816-lmsquizweekfix3';
...
(function registerPortalServiceWorker() {
    ...
    const PORTAL_SERVICE_WORKER_VERSION = '20260823-groupactivity4';
